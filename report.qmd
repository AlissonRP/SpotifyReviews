...
Para a tristeza daqueles que tendem a inclinar-se a suspeitar mais do mal que do bem, temos agora uma quantidade levemente superior para casos de *reviews* de sentimentos positivos ^[O amor venceu!!], dessa forma em termos de modelagem, é dito um problema de classes^[Onde classes refere-se á: Positivo e Negativo] balanceadas.


\subsubsection{Count Vectorization}
A ideia é bastante simples, vamos criar uma coluna/vetor para cada palavra única no banco de dados e associar a quantidade de vezes que aparece no *review* escrito, um exemplo didático pode ser visto na figura NN.

\begin{figure}[t]
\includegraphics[width=8cm]{docs/imgs/vector.jpg}
\centering
\end{figure}
![img](docs/imgs/vector.jpg){fig-align="center"}
